package id.beedev.bee_thermal_printer;
...
public class BeeThermalPrinterPlugin implements FlutterPlugin, ActivityAware,MethodCallHandler, RequestPermissionsResultListener {
  ...
  public BeeThermalPrinterPlugin() {
  }
